...
export default function CatchUpDigest() {
  return (
    <aside className="mx-4 mt-18 flex h-[148px] shrink-0 flex-col rounded-xl border border-line bg-surface px-18 pt-4 md:mx-2 md:h-32 md:flex-row md:items-start">
      ...
      <Button className="hidden h-[42px] min-h-[42px] w-40 shrink-0 px-6 md:mt-1 md:inline-flex">Review updates</Button>
    </aside>
  );
}
