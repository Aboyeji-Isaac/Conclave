...
function ActivityRows() {
  if (!isDevAuthBypass) return <div className="rounded-panel border border-dashed border-line px-6 py-12 text-center"><p className="text-sm font-medium text-ink">Nothing new yet</p><p className="mt-1 text-sm text-muted">Open a room to continue the conversation.</p></div>;
