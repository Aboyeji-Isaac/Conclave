...
function MetricCard({ metric }) {
  return <article className="h-28 rounded-xl border border-line bg-surface px-5 py-4"><strong className={`text-xl font-bold ${metric.color}`}>{isDevAuthBypass ? metric.previewValue : '0'}</strong><p className="mt-2.5 text-sm text-muted">{metric.label}</p></article>;
}
